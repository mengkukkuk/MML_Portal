 ...
 * except updatePollInterval — operators may call that one too.
 */
...
export async function updatePollInterval(id, pollIntervalSeconds) {
  const { data } = await apiClient.patch(`/panels/${id}/poll-interval`, {
